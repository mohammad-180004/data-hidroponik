...
<html lang="en">
<head>
	<title>Mendapat Tambahan Cahaya LED Biru dan Merah</title>
	<?php include './include/head.php'; ?>
</head>
<body>
	<?php include './include/sidebar-menu.php'; ?>
	<?php $table_name = "growth_blue_red_led" ?>

	<!-- Halaman Konten -->
	<div id="content" class="p-4 p-md-5 pt-5">
		<h2 class="mb-4" style='color: black; font-size: 32px; font-weight: bold;'>
			Pertumbuhan Tanaman yang Mendapatkan Tambahan Cahaya LED Biru dan Merah
		</h2>
		<table>
